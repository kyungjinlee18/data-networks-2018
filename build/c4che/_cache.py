...
CFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-nbjU53/python2.7-2.7.15~rc1=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-nbjU53/python2.7-2.7.15~rc1=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-nbjU53/python2.7-2.7.15~rc1=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-nbjU53/python2.7-2.7.15~rc1=.', '-fstack-protector-strong', '-fno-strict-aliasing']
CXXFLAGS_PYEXT = ['-pthread', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-nbjU53/python2.7-2.7.15~rc1=.', '-fstack-protector-strong', '-fno-strict-aliasing', '-g', '-fwrapv', '-O2', '-g', '-fdebug-prefix-map=/build/python2.7-nbjU53/python2.7-2.7.15~rc1=.', '-fstack-protector-strong', '-fno-strict-aliasing']
...
EXAMPLE_DIRECTORIES = ['udp', 'error-model', 'stats', 'energy', 'tutorial', 'tcp', 'udp-client-server', 'ipv6', 'naming', 'traffic-control', 'wireless', 'routing', 'matrix-topology', 'realtime', 'socket']
...
NS3_EXECUTABLE_PATH = ['/home/2018-22221/workspace/ns-allinone-3.29/ns-3.29/build/src/fd-net-device', '/home/2018-22221/workspace/ns-allinone-3.29/ns-3.29/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/2018-22221/workspace/ns-allinone-3.29/ns-3.29/build/lib']
...
cfg_files = ['/home/2018-22221/workspace/ns-allinone-3.29/ns-3.29/build/ns3/config-store-config.h', '/home/2018-22221/workspace/ns-allinone-3.29/ns-3.29/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
